package tavares.janine.exemploh2mysql.controller;
...
import tavares.janine.exemploh2mysql.repository.ClientRepository;
...
public class ClientController {
    ...
    @GetMapping
    private ResponseEntity<List<ClientEntity>> findAll() {
